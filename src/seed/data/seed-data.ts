...
export const initialData: SeedData = {
  ...
  products: [
    {
      description: 'Una camiseta de manga corta con el logo de Bing',
      images: ['bing-shirt-1.jpg', 'bing-shirt-2.jpg'],
      stock: 5,
      price: 200,
      sizes: ['S', 'M', 'L', 'XL'],
      slug: 'bing-shirt',
      tags: ['bing', 'shirt', 'logo', 'white'],
      title: 'Camiseta de Bing',
      type: 'shirts',
      gender: 'unisex',
    },
    {
      description: 'Un pantalón negro de vestir con bolsillos laterales',
      images: ['black-pants-1.jpg', 'black-pants-2.jpg'],
      stock: 10,
      price: 600,
      sizes: ['M', 'L', 'XL', 'XXL'],
      slug: 'black-pants',
      tags: ['pants', 'black', 'dress', 'formal'],
      title: 'Pantalón negro de vestir',
      type: 'pants',
      gender: 'men',
    },
    {
      description: 'Una sudadera con capucha y estampado de gato',
      images: ['cat-hoodie-1.jpg', 'cat-hoodie-2.jpg'],
      stock: 15,
      price: 400,
      sizes: ['XS', 'S', 'M', 'L'],
      slug: 'cat-hoodie',
      tags: ['hoodie', 'cat', 'cute', 'pink'],
      title: 'Sudadera de gato',
      type: 'hoodies',
      gender: 'women',
    },
    {
      description: 'Un sombrero de fieltro con una pluma de adorno',
      images: ['felt-hat-1.jpg', 'felt-hat-2.jpg'],
      stock: 20,
      price: 300,
      sizes: [],
      slug: 'felt-hat',
      tags: ['hat', 'felt', 'feather', 'brown'],
      title: 'Sombrero de fieltro',
      type: 'hats',
      gender: 'men',
    },
    {
      description: 'Una camisa de manga larga con botones de color azul',
      images: ['blue-shirt-1.jpg', 'blue-shirt-2.jpg'],
      stock: 25,
      price: 350,
      sizes: ['S', 'M', 'L', 'XL'],
      slug: 'blue-shirt',
      tags: ['shirt', 'blue', 'button', 'cotton'],
      title: 'Camisa azul',
      type: 'shirts',
      gender: 'men',
    },
    {
      description: 'Un pantalón de lino con cintura elástica de color beige',
      images: ['linen-pants-1.jpg', 'linen-pants-2.jpg'],
      stock: 30,
      price: 450,
      sizes: ['XS', 'S', 'M', 'L'],
      slug: 'linen-pants',
      tags: ['pants', 'linen', 'beige', 'comfortable'],
      title: 'Pantalón de lino',
      type: 'pants',
      gender: 'women',
    },
    {
      description: 'Una sudadera con capucha y bolsillo de color verde',
      images: ['green-hoodie-1.jpg', 'green-hoodie-2.jpg'],
      stock: 35,
      price: 500,
      sizes: ['S', 'M', 'L', 'XL', 'XXL'],
      slug: 'green-hoodie',
      tags: ['hoodie', 'green', 'pocket', 'cozy'],
      title: 'Sudadera verde',
      type: 'hoodies',
      gender: 'unisex',
    },
    {
      description: 'Un sombrero de lana con un pompón de color blanco',
      images: ['wool-hat-1.jpg', 'wool-hat-2.jpg'],
      stock: 40,
      price: 250,
      sizes: [],
      slug: 'un-sombrero-de-lana',
      tags: ['hat', 'wool', 'white', 'winter'],
      title: 'Sombrero de lana blanco',
      type: 'hats',
      gender: 'kid',
    },
    {
      description: 'Una camisa de manga corta con estampado de dinosaurios',
      images: ['dino-shirt-1.jpg', 'dino-shirt-2.jpg'],
      stock: 45,
      price: 300,
      sizes: ['XS', 'S', 'M', 'L'],
      slug: 'dino-shirt',
      tags: ['shirt', 'dinosaur', 'funny', 'cotton'],
      title: 'Camisa de dinosaurios',
      type: 'shirts',
      gender: 'kid',
    },
    {
      description: 'Un pantalón de chándal con rayas de color rojo',
      images: ['track-pants-1.jpg', 'track-pants-2.jpg'],
      stock: 50,
      price: 350,
      sizes: ['S', 'M', 'L', 'XL', 'XXL'],
      slug: 'track-pants-rojo',
      tags: ['pants', 'track', 'red', 'sporty'],
      title: 'Pantalón de chándal Rojo',
      type: 'pants',
      gender: 'men',
    },
    {
      description: 'Un pantalón de mezclilla con bolsillos y cinturón',
      images: ['denim-pants-1.jpg', 'denim-pants-2.jpg'],
      stock: 15,
      price: 500,
      sizes: ['S', 'M', 'L', 'XL'],
      slug: 'denim-pants',
      tags: ['pants', 'denim', 'casual', 'blue'],
      title: 'Pantalón de mezclilla',
      type: 'pants',
      gender: 'unisex',
    },
    {
      description: 'Una sudadera con capucha y cremallera de color rojo',
      images: ['red-hoodie-1.jpg', 'red-hoodie-2.jpg'],
      stock: 20,
      price: 400,
      sizes: ['M', 'L', 'XL', 'XXL'],
      slug: 'red-hoodie',
      tags: ['hoodie', 'red', 'zipper', 'warm'],
      title: 'Sudadera roja',
      type: 'hoodies',
      gender: 'men',
    },
    {
      description: 'Un sombrero de paja con una cinta negra',
      images: ['straw-hat-1.jpg', 'straw-hat-2.jpg'],
      stock: 25,
      price: 150,
      sizes: [],
      slug: 'straw-hat',
      tags: ['hat', 'straw', 'black', 'summer'],
      title: 'Sombrero de paja',
      type: 'hats',
      gender: 'women',
    },
    {
      description: 'Una camisa de manga larga con cuadros de colores',
      images: ['plaid-shirt-1.jpg', 'plaid-shirt-2.jpg'],
      stock: 30,
      price: 300,
      sizes: ['S', 'M', 'L', 'XL'],
      slug: 'plaid-shirt',
      tags: ['shirt', 'plaid', 'colorful', 'cotton'],
      title: 'Camisa de cuadros',
      type: 'shirts',
      gender: 'men',
    },
    {
      description: 'Un pantalón de yoga con estampado de flores',
      images: ['floral-pants-1.jpg', 'floral-pants-2.jpg'],
      stock: 35,
      price: 350,
      sizes: ['XS', 'S', 'M', 'L'],
      slug: 'floral-pants',
      tags: ['pants', 'yoga', 'floral', 'stretch'],
      title: 'Pantalón de yoga floral',
      type: 'pants',
      gender: 'women',
    },
    {
      description: 'Una sudadera con capucha y bolsillo de color gris',
      images: ['gray-hoodie-1.jpg', 'gray-hoodie-2.jpg'],
      stock: 40,
      price: 450,
      sizes: ['S', 'M', 'L', 'XL', 'XXL'],
      slug: 'gray-hoodie',
      tags: ['hoodie', 'gray', 'pocket', 'cozy'],
      title: 'Sudadera gris',
      type: 'hoodies',
      gender: 'unisex',
    },
    {
      description: 'Un sombrero de lana con un pompón de color rosa',
      images: ['wool-hat-1.jpg', 'wool-hat-2.jpg'],
      stock: 45,
      price: 200,
      sizes: [],
      slug: 'un-sombrero-de-lana-rosa',
      tags: ['hat', 'wool', 'pink', 'winter'],
      title: 'Sombrero de lana rosa',
      type: 'hats',
      gender: 'kid',
    },
    {
      description: 'Una camisa de manga corta con estampado de frutas',
      images: ['fruit-shirt-1.jpg', 'fruit-shirt-2.jpg'],
      stock: 50,
      price: 250,
      sizes: ['XS', 'S', 'M', 'L'],
      slug: 'fruit-shirt',
      tags: ['shirt', 'fruit', 'funny', 'cotton'],
      title: 'Camisa de frutas',
      type: 'shirts',
      gender: 'kid',
    },
    {
      description: 'Un pantalón de chándal con rayas de color verde',
      images: ['track-pants-1.jpg', 'track-pants-2.jpg'],
      stock: 55,
      price: 300,
      sizes: ['S', 'M', 'L', 'XL', 'XXL'],
      slug: 'track-pants-verde',
      tags: ['pants', 'track', 'green', 'sporty'],
      title: 'Pantalón de chándal verde',
      type: 'pants',
      gender: 'men',
    },
    {
      description: 'Una sudadera con capucha y estampado de unicornio',
      images: ['unicorn-hoodie-1.jpg', 'unicorn-hoodie-2.jpg'],
      stock: 60,
      price: 500,
      sizes: ['XS', 'S', 'M', 'L'],
      slug: 'unicorn-hoodie',
      tags: ['hoodie', 'unicorn', 'cute', 'sparkle'],
      title: 'Sudadera de unicornio',
      type: 'hoodies',
      gender: 'kid',
    },
    {
